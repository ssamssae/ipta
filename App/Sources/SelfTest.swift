...
enum SelfTest {
    static func run() -> Int32 {
        ...
        check("synthetic refuse Malgyeol self", target(bundle: MalgyeolInfo.bundleId, app: MalgyeolInfo.productKo).refusalReason == "말결 창")
        ...
        check("synthetic pasteLocked refuses Malgyeol", selfNote.contains("말결"), selfNote)
        ...
        check("synthetic cleaner drops leading filler", SpeechCleaner.clean("어 말결 붙여넣기") == "말결 붙여넣기", SpeechCleaner.clean("어 말결 붙여넣기"))
